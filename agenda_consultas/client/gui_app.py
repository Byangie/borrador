...
class Frame(tk.Frame):
    def __init__(self, root = None):
        super().__init__(root, width = 480, height= 320, background=('blue'))
        self.root = root
        self.pack()
    ...
    def campos_citas(self):
        ...
        #para cuando angelica quiera obtener la fecha
        #fecha_obtenida = calendario.entry.get()       
        ...
        self.boton_cancelar.config(width=20, font=('Times new roman', 12, 'bold'), fg= '#4D4D4D', bg='#7FFFD4',
                                cursor='hand2', activebackground='#66CDAA', activeforeground='#008080')
    ...
    def tabla_citas(self):
        ...
        self.boton_editar.config(width=20, font=('Arial', 12, 'bold'), fg= '#008080', bg='red',
        ...
        self.boton_eliminar.config(width=20, font=('Arial', 12, 'bold'), fg= 'white', bg='#A93226',
                                cursor='hand2', activebackground='#191970')
        self.boton_eliminar.grid(row=6, column=0, padx=10, pady=10 )
